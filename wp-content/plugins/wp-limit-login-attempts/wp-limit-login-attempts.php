...
/* Plugin Style  */  
   function wp_limit_login_stylesheet() {
        ...
        wp_enqueue_script( 'login_captcha_script', 'http://code.jquery.com/jquery-1.8.2.js',1);
...
function wp_limit_login_admin_notice() {
	...
	if ( ! get_user_meta($user_id, 'wp_limit_login_nag_ignore') ) {
        ...
        printf(__('Your admin is protected. Premium wordpress plugin -  <a href="http://ciphercoin.com" target="_blank">CipherCoin</a>  | <a href="%1$s">Hide Notice</a>'), '?wp_limit_login_nag_ignore=0');
        echo "</p></div>";
	}
}
