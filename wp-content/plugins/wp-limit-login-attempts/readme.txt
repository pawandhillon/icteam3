...
Tags: login, security, authentication, hack, proxy, admin, protection,Proxy detection, Brute Force,block,attempts,captcha,verification,bots
Requires at least: 2.8
Tested up to: 4.3.1
Stable tag: 2.1.0

Limit rate of login attempts and block ip temporarily (Up to 10 minutes). It is protecting from brute force attack. Fraud ip detection.
...
Sending wp-admin login ip to shroomery.org and getipintel.net then detect , is it blacklisted ip or not.  
...
Note:- 
It will not work in your local machine.

[youtube https://www.youtube.com/watch?v=Ry0BIvqsy3U]
...
Sorry.. It will not work in your local machine. 

== Screenshots ==
1. Captcha Verification 
2. Limit login attempts
3. Fraud proxy ip detection
