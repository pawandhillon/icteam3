...
function cryout_setting_frontpage_fn() {
	...
	echo "<div><small>".__("Enable the presentation front-page. This will become your new home page. <br><br>
		...
		if ($nirvanas['nirvana_frontpage'] == 'Enable' && get_option('show_on_front') != 'posts') {
			printf ( '<div class="slmini" style="color:#cb5920;">'.__('You have enabled the Presentation Page but your WordPress <em>Front page displays</em> option is not set to your latest posts. <br>
					Go to %1$s and make sure you have selected <strong>Your latest posts</strong> under <em>Front page displays</em>.',"nirvana").'</div>',
					'<a href="/wp-admin/options-reading.php" > WP Dashboard >> Settings >> Reading</a>');
		}
...
function cryout_setting_frontslider2_fn() {
	...
	$itemsare = array( __("Custom Slides","nirvana"), __("Latest Posts","nirvana"), __("Random Posts","nirvana"),__("Sticky Posts","nirvana"), __("Latest Posts from Category","nirvana"), __("Random Posts from Category","nirvana"), __("Specific Posts","nirvana"), __("Disabled","nirvana"));
	...
	echo "<input id='nirvana_slideNumber' name='nirvana_settings[nirvana_slideNumber]' size='4' type='text' value='".esc_attr( $nirvanas['nirvana_slideNumber'] )."' /> ".__("words","nirvana");
...
they are not left open. So if within your post you have an opened HTML tag but the except ends before that tag closes, the rest of the site will be contained in that HTML tag. -- Leave 'Disable' if unsure -- ","nirvana")."</small></div>";
}
